...
BEGIN
	...
	BEGIN TRY
		...
		WITH (
			...
			TABLOCK -- This is an option to improve performance when you are looking through the entire table during loading, as sql is loading the data, it will lock the whole table 
		);
		...
		FROM 'C:\Users\opeab\OneDrive\Documents\DataWarehouse Projects\data_baraa\datasets\source_crm\prd_info.csv' 
		WITH (
			FIRSTROW = 2,  
			FIELDTERMINATOR = ',',  
			TABLOCK -- 
